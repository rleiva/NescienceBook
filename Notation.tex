...
\chapterimage{gutenberg.pdf} % Chapter heading image
...
\item [$\mathcal{O}_\mathcal{E}$] Representation oracle
\item [$\delta_{\mathcal{E}}$] Representation function

% Representations

\item [$\mathcal{R}^{\star}$] Set of perfect representations (short for $\mathcal{R}_{\mathcal{O}_{\mathcal{E}}}^{\star}$ and $\mathcal{R}_{\mathcal{E}}^{\star}$)
\item [$\mathcal{R}_{e}^{\star}$] Set of perfect representations for $e \in \mathcal{E}$
\item [$\mathcal{R}$] Set of representations (short for $\mathcal{R}_{\mathcal{E}}$)
\item [$\mathcal{R}_{e}$] Set of representations for $e \in \mathcal{E}$
\item [$\hat{\mathcal{R}}$] Set of effective representations (short for $\hat{\mathcal{R}}_{\mathcal{E}}$)
\item [$\hat{\mathcal{R}}_{e}$] Set of effective representations for $e \in \mathcal{E}$
\item [$\hat{\mathcal{E}}$] Set of effectively known entities
