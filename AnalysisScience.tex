...
The purpose of this chapter is to apply the theoretical framework of nescience developed in the previous chapters to the study of our current scientific knowledge. Until now, our focus has been primarily on the conceptual and mathematical foundations of nescience. We have defined and analyzed the core notions of miscoding, inaccuracy, redundancy, and nescience itself as abstract quantities, exploring their properties and interrelations. In this chapter, we will shift from theory to practice: we will operationalize these notions and use them to analyze the state of contemporary science as it is documented today.
...
In Section \ref{sec:Definition_surfeit}, we introduced the concept of surfeit\index{Surfeit} as a relative measure to quantify the unnecessary effort involved in explaining an entity using a particular description. The surfeit of a description $d$ for a representation $r$ is defined as:
\[
...
\cite{chalmers2013thing}: This book is a classic introduction to the philosophy of science, offering an accessible yet rigorous discussion of how science operates, what counts as scientific knowledge, and how theories change over time. It provides the conceptual background needed to frame your empirical analysis of scientific topics and their epistemic status.

\cite{mosterin2016conceptos}: Mosterín examines the structure and evolution of scientific concepts and theories, discussing how they are created, revised, and sometimes abandoned. His perspective will support your treatment of how individual topics evolve and how nescience diminishes over time.

\cite{popper2014conjectures}: Popper's seminal work on the falsifiability criterion and the dynamics of theory change provides the philosophical grounding for your historical analysis of scientific knowledge growth. It will also help frame your treatment of the demarcation problem within your nescience framework.

\cite{latour2013laboratory}: Latour's ethnographic study shows how scientific facts are socially constructed within laboratories. Including it emphasizes that Wikipedia articles reflect not only facts but the negotiated outcomes of scientific communities, which ties directly to your measurement of inaccuracy and controversy.

\cite{ioannidis2005most}: Ioannidis empirically argues that much published science is unreliable due to biases, small samples, and statistical issues. This is crucial to motivate the need for metrics like inaccuracy in your analysis of scientific content.

\cite{van1980scientific}: Van Fraassen's constructive empiricism offers a philosophical counterpoint to scientific realism, questioning what it means for a theory to be considered “true.” This perspective enriches your discussion of what your nescience metrics are actually measuring in terms of epistemic commitment.

\cite{suppes2002representation}: Suppes' work on the formal representation of scientific theories will support your transition from individual Wikipedia articles (topics) to aggregated structures (research areas), helping ground your methodology conceptually.

\cite{li2004similarity}: This paper introduces the normalized compression distance (NCD), a practical information-theoretic tool for measuring similarity between data objects. It underpins your empirical estimation of redundancy and miscoding in Wikipedia articles.
