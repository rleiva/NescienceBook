...
My main assumption is that a research question is interesting if it satisfy the following three requirements\index{Requirements for Interesting Questions}:
...
\subsection{Combination of Topics}
