...
{\color{red} Extend uknowable to consider unknowability due to the limitations of the oracle, or unknowable given all possible oracles. And in the latter case, distinguish between unknowability due to the limitations of science, and uknowability due to inexistence.}
