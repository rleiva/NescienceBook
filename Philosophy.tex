...
There are also several adequacy requirements that any account of scientific representation should address:
...
\emph{Structuralist Conception}\index{Structuralist conception}: The structuralist conception is based on the idea of isomorphism. In its strongest form, a scientific model $M$ represents a target system $T$ if the structure of $M$ is isomorphic to the structure of $T$. In other words, there is a one-to-one correspondence between the elements and relationships in both $M$ and $T$. This approach justifies surrogative reasoning because having the same structure implies that properties and relations in the model correspond to those in the target. Furthermore, since mathematics is fundamentally concerned with the study of structures, this conception also supports the applicability of mathematics in representing natural systems.
...
Scientific knowledge is often said to be justified by appeal to evidence. However, this justification is not as straightforward or conclusive as it might first appear. It has long been recognized that general scientific theories are rarely conclusively proved or disproved in isolation. The role of justification in science is therefore complex: it is always partial, provisional, and open to revision, rather than absolute or final.
