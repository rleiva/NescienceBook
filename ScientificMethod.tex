...
The purpose of this chapter is to apply the theoretical framework of nescience developed in the previous chapters to the study of our current scientific knowledge. Until now, our focus has been primarily on the conceptual and mathematical foundations of nescience. We have defined and analyzed the core notions of miscoding, inaccuracy, surfeit, and nescience itself as abstract quantities, exploring their properties and interrelations. In this chapter, we will shift from theory to practice: we will operationalize these notions and use them to analyze the state of contemporary science as it is documented today.

Our empirical analysis will be grounded on Wikipedia's collection of scientific pages. Wikipedia provides a vast, open, and relatively well-structured repository of scientific knowledge that spans across virtually all research domains. While Wikipedia articles are not primary scientific sources, they offer an invaluable meta-level view of what the scientific community currently considers established knowledge, as well as how that knowledge is organized, debated, and maintained. By systematically processing this corpus, we can obtain large-scale approximations of the quantities defined in our theory and thereby measure the current degree of understanding achieved in different parts of science.

We will begin by presenting practical methods to approximate, for any given scientific topic, its level of miscoding, inaccuracy, redundancy, and resulting nescience. Miscoding will capture the extent to which the information contained in an article fails to describe its intended subject; inaccuracy will measure the degree of controversy or error that remains unresolved; redundancy will reflect the amount of superfluous or repetitive information; and nescience will integrate these dimensions into a single estimate of our overall ignorance about the topic. This analysis will allow us to identify which topics appear to be well understood and which remain poorly understood or even actively confused.

After establishing methods for individual topics, we will extend the analysis to broader research areas. We will study how the values of miscoding, inaccuracy, and redundancy of a collection of related topics combine to produce a macroscopic picture of the maturity and clarity of an entire field. This will enable us to compare different disciplines, discover which areas are advancing rapidly, and detect fields that may be stagnating or lacking conceptual coherence.

In addition to these cross-sectional analyses, we will also perform a longitudinal study, examining the evolution of knowledge—and, symmetrically, of nescience—over time. By analyzing historical versions of Wikipedia articles, we will trace how the levels of miscoding, inaccuracy, and redundancy have changed as scientific understanding has advanced. This will provide a first empirical glimpse of the dynamics of knowledge accumulation, revealing how scientific topics move from being poorly understood and controversial to becoming stable and concise.

Finally, this chapter will also explore a long-standing philosophical question: the demarcation problem, that is, the problem of distinguishing scientific knowledge from non-scientific or pseudoscientific claims. We will propose a practical approach to this problem based on the metrics of nescience, showing how our framework can help identify topics that fail to exhibit the patterns of knowledge growth characteristic of science.
...
\begin{figure}[h]
\centering\includegraphics[scale=0.35]{theoretical_computer_science_category_graph}
...
\begin{tabular}{|c|c|}
\hline 
Algorithm & Analysis of Boolean functions \tabularnewline
\hline 
Automated reasoning  & Farthest-first traversal \tabularnewline
\hline
Gale-Shapley algorithm & Widest path problem \tabularnewline
\hline
Cartesian tree & Viète's formula \tabularnewline
\hline
Dirac delta function & Euclidean algorithm \tabularnewline
\hline
Fast inverse square root & Rule 184 \tabularnewline
\hline
Binary search & Linear probing  \tabularnewline
\hline
Selection algorithm  & 2-satisfiability \tabularnewline
\hline
Graph homomorphism & Logic of graphs \tabularnewline
\hline
Steinitz's theorem & De Bruijn-Erdős theorem \tabularnewline
\hline
Earth-Moon problem & Turán's brick factory problem \tabularnewline
\hline
Laves graph & Rook's graph \tabularnewline
\hline
Snark & Perfect graph \tabularnewline
\hline
Clique problem & Feedback arc set \tabularnewline
\hline
Euclidean minimum spanning tree & Component \tabularnewline
\hline
Unit distance graph & Halin graph \tabularnewline
\hline
Cop-win graph & Pseudoforest \tabularnewline
\hline
Well-covered graph & Rado graph \tabularnewline
\hline
Network synthesis & Telephone number (mathematics) \tabularnewline
\hline
Book embedding & Three utilities problem \tabularnewline
\hline
BIT predicate & Pick's theorem \tabularnewline
\hline
Sylvester-Gallai theorem & RL from human feedback \tabularnewline
\hline
Finite subdivision rule & Sylvester's sequence \tabularnewline
\hline
Tropical cyclone forecast model & Shapley-Folkman lemma \tabularnewline
\hline
Theil-Sen estimator & Trie \tabularnewline
\hline
Rule of inference & Commutative property \tabularnewline
\hline
Allocator (C++) & Handshaking lemma \tabularnewline
\hline
\end{tabular}
\par\end{centering}
...
\end{tabular}
\par\end{centering}
\caption{\label{tab:Lower-redundancy-of-topics}Topics with lowest redundancy}
\end{table}
...
\begin{tabular}{|c|c|c|c|}
\hline 
Topic & Nescience & N. Inaccuracy & N. Redundancy \tabularnewline
\hline 
\hline
...
\hline
Turán's brick factory & 0.007362 & 0.370945 & 0.003718 \tabularnewline
\hline
...
\begin{figure}[h]
\centering\includegraphics[scale=0.45]{nescience_by_area}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.25]{RedundancySixScientific}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.25]{InaccuracySixScientific}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.25]{NescienceSixScientific}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.25]{RedundancySixPseudoscientific}
...
\begin{figure}[H]
\centering\includegraphics[scale=0.25]{InaccuracySixPseudoscientific}
...
The following is a list of references that are directly relevant for the chapter on "Analysis of Science", where we have applied the theory of nescience to real-world scientific knowledge using Wikipedia as a proxy. These references support our work in the following ways: philosophical foundations of science, empirical studies of scientific practice, metrics for information content and complexity, and critiques of scientific reliability.

\cite{chalmers2013thing}: This book is a classic introduction to the philosophy of science, offering an accessible yet rigorous discussion of how science operates, what counts as scientific knowledge, and how theories change over time. It provides the conceptual background needed to frame the empirical analysis in this chapter.

\cite{mosterin2016conceptos}: Mosterín examines the structure and evolution of scientific concepts and theories, discussing how they are created, revised, and sometimes abandoned. His perspective will support our treatment of how individual topics evolve and how nescience diminishes over time.

\cite{popper2014conjectures}: Popper's seminal work on the falsifiability criterion and the dynamics of theory change provides the philosophical grounding for our historical analysis of scientific knowledge growth. It will also help frame your treatment of the demarcation problem within the nescience framework.

\cite{latour2013laboratory}: Latour's ethnographic study shows how scientific facts are socially constructed within laboratories. Including it emphasizes that Wikipedia articles reflect not only facts but the negotiated outcomes of scientific communities, which ties directly to our measurement of inaccuracy and controversy.

\cite{ioannidis2005most}: Ioannidis empirically argues that much published science is unreliable due to biases, small samples, and statistical issues. This is crucial to motivate the need for metrics like inaccuracy in our analysis of scientific content.

\cite{van1980scientific}: Van Fraassen's constructive empiricism offers a philosophical counterpoint to scientific realism, questioning what it means for a theory to be considered "true." This perspective enriches our discussion of what the nescience metrics are actually measuring in terms of epistemic commitment.

\cite{suppes2002representation}: Suppes' work on the formal representation of scientific theories will support our transition from individual Wikipedia articles (topics) to aggregated structures (research areas), helping ground our methodology conceptually.

\cite{li2004similarity}: This paper introduces the normalized compression distance (NCD), a practical information-theoretic tool for measuring similarity between data objects. It underpins our empirical estimation of redundancy and miscoding in Wikipedia articles.

\cite{li2013introduction}: This is the definitive reference for Kolmogorov complexity, the theoretical foundation for your measures of miscoding, redundancy, and ultimately nescience. It provides both the mathematical background and many applied examples.

\cite{cebrian2005common}: This article warns about practical issues when using real compressors to approximate Kolmogorov complexity. It is highly relevant for the methodological section where you will approximate your metrics on Wikipedia data.
...
% 
% [1]: https://www.science.org/doi/10.1126/science.1258096 "The new frontier of genome engineering with CRISPR-Cas9 - Science"
% [2]: https://www.nature.com/articles/nbt.3659 "Applications of CRISPR technologies in research and beyond - Nature"
% [3]: https://www.science.org/doi/10.1126/science.1102896 "Electric Field Effect in Atomically Thin Carbon Films - Science"
% [4]: https://link.aps.org/doi/10.1103/RevModPhys.81.109 "The electronic properties of graphene | Rev. Mod. Phys."
% [5]: https://www.nature.com/articles/nature14539 "Deep learning - Nature"
% [6]: https://www.sciencedirect.com/science/article/pii/S0893608014002135 "Deep learning in neural networks: An overview - ScienceDirect.com"
