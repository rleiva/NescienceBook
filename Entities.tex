...
{\color{red}TODO: Remov the part on topology.}
...
{\color{red} A research area is formally treated as a subset of E. In practice, however, scientifically meaningful areas are not arbitrary subsets; they are typically unified by a common kind, level of organization, mechanism, or dependence structure. (add cross-references)}
