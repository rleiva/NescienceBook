...
\begin{definition}
Given a joint probability distribution $P(X_1 = x_1, X_2 = x_2, \ldots, X_n = x_n)$ for a set of discrete random variables $(X_1, X_2, \ldots, X_n)$, the \emph{marginal distribution}\index{Marginal distribution} of any subset of these variables, say $(X_1, X_2, \ldots, X_k)$ where $k \leq n$, is obtained by summing the joint distribution over all possible values of the remaining variables. Specifically, the marginal probability function  of $(X_1, X_2, \ldots, X_k)$ is given by:
\[
