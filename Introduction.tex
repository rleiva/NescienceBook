...
\begin{tikzpicture}
    ...
    \draw[->] (representations) -- node[above,midway] {encode} (entities);
    \draw[->] (descriptions) -- node[above,midway] {model} (representations);
    \draw[dashed,->] (descriptions) to [bend right=45] node[above,midway] {explain?} (entities);
\end{tikzpicture}
