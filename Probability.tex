...
Bayes' theorem is a direct consequence of the definition of conditional probability. It is not a property that can be derived from the axioms, and so, it's theoretical justification in this context is limited.
